    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-950 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-card p-10 relative z-10 m-4 border border-border dark:border-white/5">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-textHeadings dark:text-slate-100 uppercase tracking-tighter mb-2">Create Account</h1>
          <p className="text-[10px] text-textSecondary dark:text-slate-400 font-black uppercase tracking-[0.2em]">
            Join the Finova Global Registry
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-[10px] font-black text-textHeadings dark:text-slate-300 mb-2 uppercase tracking-widest">Full Name</label>
            <input
              type="text"
              required
              value={name}
        ...
        <p className="mt-10 text-[10px] text-textSecondary dark:text-slate-400 text-center font-black uppercase tracking-widest">
          ...
          <Link to="/login" className="text-primary-600 dark:text-primary-400 font-black border-b border-primary-600/30 hover:border-primary-600 transition-all ml-1">
            SIGN IN
          </Link>
        </p>
      </div>
